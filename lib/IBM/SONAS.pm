...
our @METHODS = qw(health disk export filesystem interface mount node quota 
replication service snapshot task);

our @ATTRS = qw(cluster_throughput cluster_client_throughput 
...
This is a functionally equivalent non-caching implementation of the B<mount> 
method.
...
Please report any bugs or feature requests to C<bug-ibm-sonas at rt.cpan.org>, 
or through the web interface at 
L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=IBM-SONAS>.  I will be 
